...
function showTips( tips, height, time ){
    ...
    $( 'div.tipsClass' ).css({
        ...
        'opacity' : '0.90.htm'/*tpa=http://demo.ddi9.com/Public/Front/newadmin/resource/js/0.90*/,
        'z-index' : '9999'
    }).show();
...
function weixin_login(){
    ...
    d.setWidth(360);
    d.show('center',1);
    $.getScript("../../../../../../res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"/*tpa=http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js*/, function(){
        var obj = new WxLogin({
            id:"login_container", 
