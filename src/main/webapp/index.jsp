...
<div id="wrapper" style="background-color:#3c4043">
    ...
    <div class="row head-bar" id="head-bar">
        ...
        <div class="col-lg-7 col-md-8 col-sm-9 col-xs-6 head-right">
            <div class="hidden-xs">
                <a href="../shouye/shouye.html" class="index">网站首页</a>
                <a href="Admin_Index_clearCache.html" class="qchc">清除缓存</a>
                <a href="javascript:;" onclick="reset_pwd('修改密码','Admin_System_editPassword.html',360,320)" class="edit">修改密码</a>
                <a href="Admin_Login_loginout.html" class="loginout">退出</a>
            </div>
            <div class="dropdown ">
    		<span class="clear">
